...
var (
	...
	DefaultAuthorizeCodeTokenCfg = &TokenExpConf{
		AccessTokenExp:    time.Hour * 2,
		RefreshTokenExp:   time.Hour * 24 * 3,
		IsGenerateRefresh: true,
	}
	DefaultImplicitTokenCfg = &TokenExpConf{AccessTokenExp: time.Hour * 1}
	DefaultPasswordTokenCfg = &TokenExpConf{
		AccessTokenExp:    time.Hour * 2,
		RefreshTokenExp:   time.Hour * 24 * 7,
		IsGenerateRefresh: true,
	}
	DefaultClientTokenCfg  = &TokenExpConf{AccessTokenExp: time.Hour * 2}
