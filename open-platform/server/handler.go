...
type (
	...
	ClientScopeHandler func(tgr *manage.TokenGenerateRequest) (allowed bool, err error)
	...
	RefreshingScopeHandler func(tgr *manage.TokenGenerateRequest, oldScope string) (allowed bool, err error)

	// RefreshingValidationHandler check if refresh_token is still valid. eg no revocation or other
	RefreshingValidationHandler func(ti models.TokenInfo) (allowed bool, err error)
