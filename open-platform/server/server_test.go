...
import (
	...
	"github.com/767829413/advanced-go/open-platform/server"
...
func clientStore(domain string, public bool) store.ClientStore {
...
func TestClientCredentials(t *testing.T) {
	...
	srv.SetAllowedGrantType(config.ClientCredentials)
	...
	srv.SetAuthorizeScopeHandler(
		func(w http.ResponseWriter, r *http.Request) (scope string, err error) {
			return
		},
	)
	srv.SetClientScopeHandler(func(tgr *manage.TokenGenerateRequest) (allowed bool, err error) {
		allowed = true
		return
	})
